...
function Traks() {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-black  z-10 py-[100px] overflow-auto flex flex-col items-start px-[30px]">
      ...
      <div className="w-full flex flex-row mx-auto container ">
        <div className="w-full flex flex-col items-center justify-center py-[30px]">
          ...
          <div className="my-[10px] w-full  h-[50px] flex justify-center items-center  font-medium text-white ">
            <audio
              controls
